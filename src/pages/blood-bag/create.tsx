...
const BloodBagCreate = () => {
  const go = useGo();
  const goToListPage = () => {
    go({
      to: { resource: "blood_bag", action: "list" },
  ...
  const { selectProps: bloodTypeSelectProps, query: bloodTypeQuery } =
    useSelect({
      optionLabel: "code",
      optionValue: "id",
      resource: "blood_type",
        ...
        <Form {...formProps} layout="vertical">
          ...
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: "Veuillez entrer votre groupe sanguin",
              },
            ]}
          >
            <Select
              options={bloodTypeQuery.data?.data || []}
